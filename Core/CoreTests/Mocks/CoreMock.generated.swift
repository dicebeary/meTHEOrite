...
open class CacheableMock: Cacheable, Mock {
    ...
    open func save<T: Codable>(object: T, forKey: String) {
        addInvocation(.m_save__object_objectforKey_forKey(Parameter<T>.value(`object`).wrapAsGeneric(), Parameter<String>.value(`forKey`)))
		let perform = methodPerformValue(.m_save__object_objectforKey_forKey(Parameter<T>.value(`object`).wrapAsGeneric(), Parameter<String>.value(`forKey`))) as? (T, String) -> Void
		perform?(`object`, `forKey`)
    }

    open func load<T: Codable>(type: T.Type, forKey: String) -> T? {
        addInvocation(.m_load__type_typeforKey_forKey(Parameter<T.Type>.value(`type`).wrapAsGeneric(), Parameter<String>.value(`forKey`)))
		let perform = methodPerformValue(.m_load__type_typeforKey_forKey(Parameter<T.Type>.value(`type`).wrapAsGeneric(), Parameter<String>.value(`forKey`))) as? (T.Type, String) -> Void
		perform?(`type`, `forKey`)
		var __value: T? = nil
		do {
		    __value = try methodReturnValue(.m_load__type_typeforKey_forKey(Parameter<T.Type>.value(`type`).wrapAsGeneric(), Parameter<String>.value(`forKey`))).casted()
		} catch {
			// do nothing
		}
		return __value
    ...
    fileprivate enum MethodType {
        case m_save__object_objectforKey_forKey(Parameter<GenericAttribute>, Parameter<String>)
        case m_load__type_typeforKey_forKey(Parameter<GenericAttribute>, Parameter<String>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_save__object_objectforKey_forKey(let lhsObject, let lhsForkey), .m_save__object_objectforKey_forKey(let rhsObject, let rhsForkey)):
				var results: [Matcher.ParameterComparisonResult] = []
				results.append(Matcher.ParameterComparisonResult(Parameter.compare(lhs: lhsObject, rhs: rhsObject, with: matcher), lhsObject, rhsObject, "object"))
				results.append(Matcher.ParameterComparisonResult(Parameter.compare(lhs: lhsForkey, rhs: rhsForkey, with: matcher), lhsForkey, rhsForkey, "forKey"))
				return Matcher.ComparisonResult(results)

            case (.m_load__type_typeforKey_forKey(let lhsType, let lhsForkey), .m_load__type_typeforKey_forKey(let rhsType, let rhsForkey)):
				var results: [Matcher.ParameterComparisonResult] = []
        ...
        func intValue() -> Int {
            switch self {
            case let .m_save__object_objectforKey_forKey(p0, p1): return p0.intValue + p1.intValue
            case let .m_load__type_typeforKey_forKey(p0, p1): return p0.intValue + p1.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_save__object_objectforKey_forKey: return ".save(object:forKey:)"
            case .m_load__type_typeforKey_forKey: return ".load(type:forKey:)"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func load<T: Codable>(type: Parameter<T.Type>, forKey: Parameter<String>, willReturn: T?...) -> MethodStub {
            return Given(method: .m_load__type_typeforKey_forKey(`type`.wrapAsGeneric(), `forKey`), products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func load<T: Codable>(type: Parameter<T.Type>, forKey: Parameter<String>, willProduce: (Stubber<T?>) -> Void) -> MethodStub {
            let willReturn: [T?] = []
			let given: Given = { return Given(method: .m_load__type_typeforKey_forKey(`type`.wrapAsGeneric(), `forKey`), products: willReturn.map({ StubProduct.return($0 as Any) })) }()
    ...
    public struct Verify {
        ...
        public static func save<T>(object: Parameter<T>, forKey: Parameter<String>) -> Verify where T:Codable { return Verify(method: .m_save__object_objectforKey_forKey(`object`.wrapAsGeneric(), `forKey`))}
        public static func load<T>(type: Parameter<T.Type>, forKey: Parameter<String>) -> Verify where T:Codable { return Verify(method: .m_load__type_typeforKey_forKey(`type`.wrapAsGeneric(), `forKey`))}
    }
    ...
    public struct Perform {
        ...
        public static func save<T>(object: Parameter<T>, forKey: Parameter<String>, perform: @escaping (T, String) -> Void) -> Perform where T:Codable {
            return Perform(method: .m_save__object_objectforKey_forKey(`object`.wrapAsGeneric(), `forKey`), performs: perform)
        }
        public static func load<T>(type: Parameter<T.Type>, forKey: Parameter<String>, perform: @escaping (T.Type, String) -> Void) -> Perform where T:Codable {
            return Perform(method: .m_load__type_typeforKey_forKey(`type`.wrapAsGeneric(), `forKey`), performs: perform)
        }
    }
...
// MARK: - MeteoriteLandingServiceInterface

open class MeteoriteLandingServiceInterfaceMock: MeteoriteLandingServiceInterface, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func getMeteoriteLandings() -> Single<[MeteoriteLandingApiModel]> {
        addInvocation(.m_getMeteoriteLandings)
		let perform = methodPerformValue(.m_getMeteoriteLandings) as? () -> Void
		perform?()
		var __value: Single<[MeteoriteLandingApiModel]>
		do {
		    __value = try methodReturnValue(.m_getMeteoriteLandings).casted()
		} catch {
			onFatalFailure("Stub return value not specified for getMeteoriteLandings(). Use given")
			Failure("Stub return value not specified for getMeteoriteLandings(). Use given")
		}
		return __value
    }
    ...
    fileprivate enum MethodType {
        case m_getMeteoriteLandings

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_getMeteoriteLandings, .m_getMeteoriteLandings): return .match
            }
        }

        func intValue() -> Int {
            switch self {
            case .m_getMeteoriteLandings: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_getMeteoriteLandings: return ".getMeteoriteLandings()"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func getMeteoriteLandings(willReturn: Single<[MeteoriteLandingApiModel]>...) -> MethodStub {
            return Given(method: .m_getMeteoriteLandings, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func getMeteoriteLandings(willProduce: (Stubber<Single<[MeteoriteLandingApiModel]>>) -> Void) -> MethodStub {
            let willReturn: [Single<[MeteoriteLandingApiModel]>] = []
			let given: Given = { return Given(method: .m_getMeteoriteLandings, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<[MeteoriteLandingApiModel]>).self)
			willProduce(stubber)
			return given
        }
    }
    ...
    public struct Verify {
        ...
        public static func getMeteoriteLandings() -> Verify { return Verify(method: .m_getMeteoriteLandings)}
    }
    ...
    public struct Perform {
        ...
        public static func getMeteoriteLandings(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_getMeteoriteLandings, performs: perform)
        }
    }
